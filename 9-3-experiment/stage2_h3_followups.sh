...
RUN_ROOT="$REPO/data/runs/nanodesign-v1/stage2-h3-followups"
...
case "$mode" in
  seqonly-t05)
    extra=(--coordinate-loss-weight 0 --training-noise-level 0.5)
    ;;
  joint-seq-w1)
    extra=(--coordinate-loss-weight 4 --sequence-loss-weight 1)
    ;;
  *)
