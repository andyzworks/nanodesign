...
reach 17.66% Binder recovery at 6K and 32.59% H3 recovery at 3K; RNA has written its
...
initialization), so the exact run is continuing to 12K before a Stage-3 decision. H3
