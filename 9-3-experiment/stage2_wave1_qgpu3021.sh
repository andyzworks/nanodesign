...
run_one 0 binder-sequence-only protein_binder --coordinate-loss-weight 0 & p0=$!
run_one 1 h3-sequence-only antibody_h3 --coordinate-loss-weight 0 & p1=$!
run_one 2 rna-sequence-only rna --coordinate-loss-weight 0 & p2=$!
run_one 3 binder-all-valid protein_binder --sequence-supervision all_valid & p3=$!
